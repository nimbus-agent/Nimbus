...
**Status:** Phase 5 ✅ · Phase 6 (Team) 🚧 nearly complete — Slices 1–8 shipped (federation, team-vault/quorum, identity/SSO/SCIM, org policy, ChatOps, cross-colleague agents, data-warehouse/BI + lineage, and Share & Virality); invariants through I27; schema V42. Latest release `v0.11.2`; `v0.1.0` was the first headless GA (2026-05-09; Gateway + CLI + VS Code extension; Tauri desktop deferred to Phase 13). Dated log (canonical): [`docs/CHANGELOG.md`](./docs/CHANGELOG.md). Status + acceptance criteria: [`docs/roadmap.md`](./docs/roadmap.md).
