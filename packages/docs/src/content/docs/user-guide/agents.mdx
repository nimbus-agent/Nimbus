...
description: The twelve read-only agents that ship inside the Gateway — expert, impact, catchup, why, glossary, decisions, ownership, ghost, conflicts, huddle, janitor, and preflight.
---
...
| [`nimbus owners`](#nimbus-owners-path) | Who wrote this code, and how much? | Local index (git blame) |
...
Answers *who wrote this code, and how much?* — ranks people against a file,
...
`<path>` must be inside a configured git-aware root — either a
