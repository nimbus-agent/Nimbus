---
title: Nimbus Companion privacy
description: Nimbus Companion, the Nimbus browser extension, collects no data. It is local-first and talks only to your own gateway on 127.0.0.1 — no telemetry, no cloud.
---

import { Aside } from "@astrojs/starlight/components";

Privacy policy for the [Nimbus Companion](/user-guide/web-clipper/) browser
extension (Chrome + Firefox), formerly "Nimbus Web Clipper".
