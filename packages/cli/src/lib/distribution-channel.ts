 ...
 *
 * NOTE: This is an intentional CLI-local copy of the gateway module at
 * packages/gateway/src/config/distribution-channel.ts. The CLI must reach the
 * gateway IPC-only — no source imports across the package boundary — so each
 * package carries its own pure copy of this logic.
 */
