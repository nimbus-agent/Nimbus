...
/**
 * Mints nothing — `gcloud logging` is a native CLI that authenticates as the configured service-account key through runGcloudCommand (gcloudKeyFileEnv — gcloud reads CLOUDSDK_AUTH_CREDENTIAL_FILE_OVERRIDE, not the ADC variable). Shells
