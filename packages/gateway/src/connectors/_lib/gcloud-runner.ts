...
/**
 * Spawn a gcloud CLI command authenticated as the service-account key at credPath (gcloudKeyFileEnv sets CLOUDSDK_AUTH_CREDENTIAL_FILE_OVERRIDE, which gcloud reads, plus GOOGLE_APPLICATION_CREDENTIALS for client libraries), capturing stdout. Returns
