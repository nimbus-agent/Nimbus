...
// clone and cloneRanges are scaffolding for future backtracking; not called on current happy
// paths but retained as part of the design — the DFS uses shared-mutable state which is
// sufficient for the acyclic cases the solver currently handles.
...
// Silence unused-variable warnings for the backtracking scaffolding.
// These are intentionally kept for future use per spec design notes.
void (clone as unknown);
void (cloneRanges as unknown);
