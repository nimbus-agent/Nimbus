...
* **cli:** nimbus init and nimbus demo end on the guided tour ([#1570](https://github.com/nimbus-agent/Nimbus/issues/1570)) ([fc8ce7c](https://github.com/nimbus-agent/Nimbus/commit/fc8ce7ce07de2ff8219d9647d922ae4576837a67))
...
* **audit:** index lane census (report-only) ([#1561](https://github.com/nimbus-agent/Nimbus/issues/1561)) ([863f621](https://github.com/nimbus-agent/Nimbus/commit/863f621f23cfecd36d68462595478f9dbb40a249))
...
* **cli:** nimbus demo — a seeded synthetic org and a three-brief tour ([#1547](https://github.com/nimbus-agent/Nimbus/issues/1547)) ([b238a13](https://github.com/nimbus-agent/Nimbus/commit/b238a1386312746994a8a3ab4e668464c5dd1e5d))
* isolated demo root for nimbus --demo (invariant I41) ([#1545](https://github.com/nimbus-agent/Nimbus/issues/1545)) ([8791c19](https://github.com/nimbus-agent/Nimbus/commit/8791c1990e85f27364e0c8110da43709fba9b07f))
...
* **connectors:** let Jira, Confluence, GitLab, dbt and the Teams bot reach their configured host from the sandbox ([#1536](https://github.com/nimbus-agent/Nimbus/issues/1536)) ([d4465f9](https://github.com/nimbus-agent/Nimbus/commit/d4465f9c3c784532a056cfef0bc63433d2936af2))
* **connectors:** make connector auth refuse vault-key services with the exact vault set commands ([#1537](https://github.com/nimbus-agent/Nimbus/issues/1537)) ([02011df](https://github.com/nimbus-agent/Nimbus/commit/02011dfa35ceaee8231863de7d43ffb405beb0ef))
* **embedding:** cancel timed-out query embedding work, not just abandon it ([#1542](https://github.com/nimbus-agent/Nimbus/issues/1542)) ([35b0aa8](https://github.com/nimbus-agent/Nimbus/commit/35b0aa86cf38bdb5fdf74dc3b506f4a8b7f8cf52))
...
* **cli:** add nimbus tool run to invoke a saved generated tool ([#1521](https://github.com/nimbus-agent/Nimbus/issues/1521)) ([a89bd27](https://github.com/nimbus-agent/Nimbus/commit/a89bd2762c274d06ccf20d766eb300ebe0e871ed))

## [7.23.0](https://github.com/nimbus-agent/Nimbus/compare/v7.22.0...v7.23.0) (2026-09-15)


### Features

* **cli:** nimbus explain last — an X-ray of the most recent nimbus ask ([#1514](https://github.com/nimbus-agent/Nimbus/issues/1514)) ([755c2b6](https://github.com/nimbus-agent/Nimbus/commit/755c2b6019479a1313ada85ab4d3db6726c4add4))
* **cli:** nimbus tail — follow the gateway's operational event stream ([#1511](https://github.com/nimbus-agent/Nimbus/issues/1511)) ([9f70962](https://github.com/nimbus-agent/Nimbus/commit/9f70962084caa57c3eba05d99be40f99dd58187b))

## [7.22.0](https://github.com/nimbus-agent/Nimbus/compare/v7.21.1...v7.22.0) (2026-09-13)


### Features

* **agents:** nimbus oncall — the seventeenth built-in agent ([#1509](https://github.com/nimbus-agent/Nimbus/issues/1509)) ([27c4211](https://github.com/nimbus-agent/Nimbus/commit/27c42111e1c44911c56f62b3c558d8808e0ccedb))
...
* **agents:** nimbus changelog — the fifteenth built-in agent ([#1496](https://github.com/nimbus-agent/Nimbus/issues/1496)) ([bc1139b](https://github.com/nimbus-agent/Nimbus/commit/bc1139b813040248de0a594de07a04a62a57bb61))
...
* **toolgen:** runtime tool generation PR 3 of 3 — persistence + signing ([#1487](https://github.com/nimbus-agent/Nimbus/issues/1487)) ([52644ce](https://github.com/nimbus-agent/Nimbus/commit/52644cef588e44f3d82621a4589ca682787bafba))
