...
| HTTP write surface (`I13`) | `ipc/http-server.ts` | dedicated read-write handle; `WRITE_ROUTE_ALLOWLIST` (5 routes) — `POST /v1/deployments` + `PUT /v1/admin/policy` (Phase 6 Slice 4 signed-policy install) |
