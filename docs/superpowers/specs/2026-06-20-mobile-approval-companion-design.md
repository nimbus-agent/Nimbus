...
2. **Owner-sink contention.** If a phone *and* a live Tauri window are both eligible owner-sinks, which wins? Wave 2's "last-writer-wins" suggests the most-recent registrant — confirm that is the desired UX (a phone waking shouldn't silently steal a request the owner is mid-approving at the desk).
