...
-- `browser` ships a driver in this delivery -- the value set is known now, and widening a CHECK
...
-- untrusted observation, and monotonic once set (the envelope may only narrow from that point on).
