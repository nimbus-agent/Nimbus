...
- [Active](#active) — Phase 6 (Team) ✅ complete (2026-06-18); Phase 7 (Engineering Excellence) is the next phase
...
| 9 | Deferred Phase 5 items (web clipper, Mendeley, Apple Mail/Cal, Workday, GitOps/ML writes) — **Wave A (Mendeley connector) ✅ delivered 2026-06-14**; remaining items planned | mostly independent |
