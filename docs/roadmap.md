...
- [ ] **Answer-quality surfaces, remaining** — devil's-advocate mode (A1), agent-persona configuration (A2), first-class negation + aggregation queries (W6-B) (Phase 7 Wave 6). Brief synthesis (A0) — the prerequisite question these three implicitly assumed answered, whether an LLM is in the brief path at all — shipped 2026-08-16; see above.
