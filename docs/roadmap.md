...
- [ ] **Implicit-knowledge agent triad (remainder)** — `nimbus glossary` / `decisions` (+ `pre-mortem`, `negotiate`), pulled forward from Phase 7 Wave 5; see [Phase 7 — Engineering Excellence](#phase-7--engineering-excellence) for the full definitions. `nimbus why` — the first of the triad — shipped 2026-07-24 (see Delivered above)
