...
- [ ] **Implicit-knowledge agent triad (remainder)** — `pre-mortem` + `negotiate`, pulled forward from Phase 7 Wave 5; see [Phase 7 — Engineering Excellence](#phase-7--engineering-excellence) for the full definitions. `nimbus why`, `nimbus glossary` and `nimbus decisions` — the first three of the triad — shipped 2026-07-24, 2026-07-30 and 2026-08-02 respectively (see Delivered above)
