...
- [ ] **Implicit-knowledge agent triad (remainder)** — `decisions` (+ `pre-mortem`, `negotiate`), pulled forward from Phase 7 Wave 5; see [Phase 7 — Engineering Excellence](#phase-7--engineering-excellence) for the full definitions. `nimbus why` and `nimbus glossary` — the first two of the triad — shipped 2026-07-24 and 2026-07-30 respectively (see Delivered above)
